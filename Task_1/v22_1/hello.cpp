...
int main()
{
    ...
    fout << "Выполнил: Тупикин Юрий"
         << "\n"
         << endl;
    fout << "Функция: $- a^{3} \\cdot \\frac{e^{- x^{2}}}{25} + x^{5} - \\frac{x^{3}}{2} + 10 x$" << endl;
    fout << "\n"
         << endl;

    fout << "Первая производная: $\\frac{2 a^{3} x e^{- x^{2}}}{25} + 5 x^{4} - \\frac{3 x^{2}}{2} + 10$" << endl;
    fout << "\n"
         << endl;
 ...
 //   fout << "\\pagebreak" << endl;
    ...
    for (int a = 1; a <= 10; a++)
    {
        ...
        fout << "\\begin{center}" << endl;
        fout << "{\\large $\\alpha = " << a << "$, $[a^{" << a << "} _r, b^{" << a << "} _r] = [0, 1.5]$}" << endl;
